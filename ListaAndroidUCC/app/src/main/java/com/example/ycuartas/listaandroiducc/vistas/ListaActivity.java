...
import com.example.ycuartas.listaandroiducc.vistas.adaptadores.TodoListAdapter;
import com.example.ycuartas.listaandroiducc.vistas.presenters.IListPresenter;
import com.example.ycuartas.listaandroiducc.vistas.presenters.ListPresenter;
...
public class ListaActivity extends AppCompatActivity implements IListView,TodoListAdapter.OnListenerItemCheck {
    ...
    @Override
    public void refrescarTareaEliminada(int posicion) {
        rvListTODO.getAdapter().notifyItemRemoved(posicion);
    }

    @Override
    public int getContadorItem() {
        return rvListTODO.getAdapter().getItemCount();
    }
