...
public class TodoListAdapter extends RecyclerView.Adapter<TodoListAdapter.ItemTodoList> {
    ...
    public TodoListAdapter(List<Pregunta> dataset, OnListenerItemCheck onListenerItemCheck) {
        super();
    ...
    public void onBindViewHolder(ItemTodoList holder, int position) {
        Pregunta pregunta = dataset.get(position);

        if(pregunta.isRespuestas()){
        ...
        holder.tvTarea.setText(pregunta.getDescripcion());
        holder.chkTarea.setChecked(pregunta.isRespuestas());
    }

    public void setDataset(List<Pregunta> dataset){
        this.dataset = dataset;
    }

    public void setItemDataset(Pregunta pregunta, int index){
        this.dataset.set(index, pregunta);
    }
